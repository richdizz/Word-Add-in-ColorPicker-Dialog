    ...
    Office.initialize = function (reason) {
        $(document).ready(function () {
            $("#btnColor").click(function () {
                Office.context.ui.displayDialogAsync("https://localhost:44300/Colors.html", { height: 40, width: 40, requireHTTPS: true }, function (result) {
                    _dlg = result.value;
                    _dlg.addEventHandler(Microsoft.Office.WebExtension.EventType.DialogMessageReceived, callback);
                });
            });
